...
urlpatterns = [
    ...
    path('campeonatos/editar/<int:id>/',
         views.campeonato_update, name='campeonato_update'),
    ...
    path('jogadores/<str:cpf>/editar/',
         views.jogador_update, name='jogador_update'),
    path('jogadores/<str:cpf>/deletar/',
         views.jogador_delete, name='jogador_delete'),
    ...
    path('treinadores/editar/<str:cpf>/',
         views.treinador_update, name='treinador_update'),
    path('treinadores/deletar/<str:cpf>/',
         views.treinador_delete, name='treinador_delete'),
    ...
    # URLs consultas
    path('jogadores_clubes_campeonatos/', views.jogadores_clubes_campeonatos,
         name='jogadores_clubes_campeonatos'),
    path('treinadores_medicos_por_clube/', views.treinadores_medicos_por_clube,
         name='treinadores_medicos_por_clube'),
    path('clubes_campeonatos_datas/', views.clubes_campeonatos_datas,
         name='clubes_campeonatos_datas'),
]
