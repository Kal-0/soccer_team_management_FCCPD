...
from .views import home, campeonato_menu, clube_menu, jogador_menu, treinador_menu, medico_menu
...
urlpatterns = [
    ...
    path('menu/clubes/', clube_menu, name='clube_menu'),
    ...
    path('menu/jogadores/', jogador_menu, name='jogador_menu'),
    ...
    path('menu/treinadores/', treinador_menu, name='treinador_menu'),
    ...
    path('treinadores/editar/<str:cpf>/',
         treinador_update, name='treinador_update'),
    path('treinadores/editar/<str:cpf>/',
         treinador_delete, name='treinador_delete'),

    path('menu/medicos/', medico_menu, name='medico_menu'),
